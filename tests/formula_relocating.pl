...
# example 1
$ss{'C1:C2'} = Formula('$ss->Sum("A1:A2")') ;
print "Example 1 => @{@ss{'C1:C2'}}\n" ;

# example 2
$ss->Reset() ;
$ss{'A1:A3'} = 1 ;
$ss{'D1:E2'} = Formula('$ss->Sum("[A]1:A[3]")',) ;
...
$ss{'D1:D2'} = Formula('$ss->Sum("[A1]:[A3]")') ;
print "D1:D2 => @{@ss{'D1:D2'}}\n" ;

$ss{'E1:E2'} = Formula('$ss->Sum("[A]1]:[A]3")') ; # ugly but accepted
print "E1:E2 => @{@ss{'E1:E2'}}\n" ;

$ss{'F1:F2'} = Formula('$ss->Sum("[A[1]:A[3]")') ;
print "F1:F2 => @{@ss{'F1:F2'}}\n" ;

$ss{'G1:G2'} = Formula('$ss->Sum("[A][1]:A3")') ;
print "G1:G2 => @{@ss{'G1:G2'}}\n" ;

$ss{'H1:H2'} = Formula('$ss->Sum("[A]]1]:[A3]")') ; #error in the address
print "H1:H2 => @{@ss{'H1:H2'}}\n" ;

$ss{'I1:I2'} = Formula('$ss->Sum("[A]]1]:")') ; #error in the address
print "I1:I2 => @{@ss{'I1:I2'}}\n" ;

$ss{'J1:J2'} = Formula('$ss->Sum("[A]]1]")') ; #error in the address
